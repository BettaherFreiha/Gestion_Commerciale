...
public class DB {
		...
		DB(String utilisateur,String motdepasse) {
			 ...
			 try {
			      ...
			      String url = "jdbc:mysql://localhost:3306/gestion_commerciale";
			      String user = "root";
			      String passwd = "";
			      ...
			      ResultSet rs=statement.executeQuery("SELECT * FROM login WHERE NomUtilisateur='"+utilisateur+"' AND ModeDePasse='"+motdepasse+"'");  
			    ...
			    ResultSet rs=statement.executeQuery("SELECT * FROM famille");
                            ...
                            while(rs.next()) {
                                CFs.add(rs.getString("CodeFamille"));
                            }
               ...
               static void SelectIDModeRegelementDB() {
                ...
                static void InsertDB(Facture facture) {
                        ...
                        try {
                            statement = connect.createStatement();
                            statement.executeUpdate("INSERT INTO facture VALUES ("+
			    		  ...
			    		  facture.getSaisiLe()+"','"+
                            ...
                            statement2[i].executeUpdate("INSERT INTO lignefac VALUES ("+
                                    facture.getIDLigneFac()[i]+ ","+
                                    facture.getNumFacture()+ ",'"+
                                    ...
                                    facture.getIDLigneCde()[i]+ ","+
                                    facture.getOrdreAffichage()[i]+ ")"
                            );
