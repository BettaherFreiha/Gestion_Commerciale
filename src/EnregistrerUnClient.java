 ...
 * @author Kira
 */
public class EnregistrerUnClient extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        EnregistrerClient.setBorder(javax.swing.BorderFactory.createMatteBorder(3, 3, 3, 3, new java.awt.Color(0, 0, 0)));
        ...
        NumClient.setEditable(false);
        NumClient.setFont(new java.awt.Font("Dialog", 0, 15)); // NOI18N
        NumClient.setEnabled(false);

        Annuler.setFont(new java.awt.Font("Dialog", 1, 15)); // NOI18N
        Annuler.setText("Annuler");
        Annuler.setBorder(javax.swing.BorderFactory.createMatteBorder(3, 3, 3, 3, new java.awt.Color(0, 0, 0)));
        ...
        Retour.setBorder(javax.swing.BorderFactory.createMatteBorder(3, 3, 3, 3, new java.awt.Color(0, 0, 0)));
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Nouveau dossier/aouter_client.PNG"))); // NOI18N
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                            ...
                            .addComponent(NumClient, javax.swing.GroupLayout.Alignment.LEADING)
                            .addComponent(Civilite, javax.swing.GroupLayout.PREFERRED_SIZE, 140, javax.swing.GroupLayout.PREFERRED_SIZE))
                        .addGap(35, 35, 35)
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addComponent(Pays1)
    ...
    private void EnregistrerClientActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_EnregistrerClientActionPerformed
        ...
        DB.AutoNum();
        NumClient.setText(Integer.toString(DB.Num));
        client.setNum(Integer.parseInt(NumClient.getText()));
        client.setNomClient(NomClient.getText());
        client.setPrenom(Prenom.getText());
        client.setAdresse(Adresse.getText());
        client.setCivilite(Civilite.getSelectedItem().toString());
        client.setSociete(Societe.getText());
        ...
        DB.InsertDB(client);
         JOptionPane.showMessageDialog( null, "Succès!", 
					      "Client Enregistré(e)", JOptionPane.INFORMATION_MESSAGE);
    }//GEN-LAST:event_EnregistrerClientActionPerformed

    private void NomClientKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_NomClientKeyPressed
        if(evt.getKeyCode()== KeyEvent.VK_ENTER)
            {
              Prenom.grabFocus();
            }
    }//GEN-LAST:event_NomClientKeyPressed
