 ...
 * @author Kira
 */
public class SupprimerUnClient extends javax.swing.JFrame {
    ...
    public SupprimerUnClient() {
        ...
        public void Actualiser(int j) {
            ...
            if(NumClient.getItemCount() != 0) {
                ...
                Adresse.setText(DB.clients.get(j).getAdresse());
                Civilite.setSelectedItem(DB.clients.get(j).getCivilite());
                Societe.setText(DB.clients.get(j).getSociete());
                Email.setText(DB.clients.get(j).getEmail());
                Ville.setText(DB.clients.get(j).getVille());
                Pays.setText(DB.clients.get(j).getPays());
                Telephone.setText(DB.clients.get(j).getTelephone());
                Mobile.setText(DB.clients.get(j).getMobile());
                Fax.setText(DB.clients.get(j).getFax());
                CodePostal.setText(DB.clients.get(j).getCodePostal());
            } else {
                NomClient.setText("");
                Prenom.setText("");
                Adresse.setText("");
    ...
    private void initComponents() {
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Nouveau dossier/supp_client.PNG"))); // NOI18N
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                            ...
                            .addComponent(NumClient, javax.swing.GroupLayout.Alignment.LEADING, 0, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
...
Jframe_Client I = new Jframe_Client();
    ...
    private void NumClientActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_NumClientActionPerformed
        ...
        if (NumClient.getSelectedIndex()!= -1) {
            ...
            Civilite.setSelectedItem(DB.clients.get(i).getCivilite());
    ...
    private void SupprimerClientActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_SupprimerClientActionPerformed
        ...
        client.setNum(Integer.parseInt(NumClient.getSelectedItem().toString()));
        ...
        DB.DeleteDB(client);
        Actualiser(NumClient.getSelectedIndex()-1);
        if(DB.deleted) {
         JOptionPane.showMessageDialog( null, "Succès!", 
					      "Client Supprimé(e)", JOptionPane.INFORMATION_MESSAGE);

        } else {
            JOptionPane.showMessageDialog( null, "Ce client ne peut pas etre supprimé(e).", 
