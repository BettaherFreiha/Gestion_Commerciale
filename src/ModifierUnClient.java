 ...
 * @author Kira
 */
public class ModifierUnClient extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Nouveau dossier/modifier_client.PNG"))); // NOI18N
    ...
    private void ModifierClientActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ModifierClientActionPerformed
        ...
        DB.UpdateDB(client);
        Actualiser(NumClient.getSelectedIndex());
         JOptionPane.showMessageDialog( null, "Succès!", 
					      "Client Modifié(e)", JOptionPane.INFORMATION_MESSAGE);
